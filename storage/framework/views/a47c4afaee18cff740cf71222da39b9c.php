...
<head>
    ...
    <meta name="description" content="Bite — <?php echo e(__('menu_page.hero.title2')); ?>. Order hot, delivered fast.">
    <title>Bite  | <?php echo e(__('menu_page.hero.title2')); ?></title>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,400&family=Playfair+Display:ital,wght@0,700;0,900;1,700&family=Tajawal:wght@400;500;700;800&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        @keyframes flyToCart {
            ...
            100% {
                transform: scale(0.2) translate(var(--fly-x, 200px), var(--fly-y, -300px));
                opacity: 0;
            }
        }
        ...
        @keyframes flameFlicker {
            ...
            50% {
                transform: scale(0.95) rotate(-2deg) translateY(1px);
                filter: drop-shadow(0 0 12px rgba(220, 38, 38, 0.8));
            }

            75% {
                transform: scale(1.05) rotate(1deg) translateY(-1px);
                filter: drop-shadow(0 0 22px rgba(251, 191, 36, 0.9));
            }
        }
        ...
        @keyframes sparkFly {
            ...
            100% {
                transform: translate(var(--spark-x, 15px), -40px) scale(0);
                opacity: 0;
            }
        }
...
<body class="bg-charcoal-950 text-white font-sans antialiased overflow-x-hidden"
    ...
    <header class="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-charcoal-950/80 border-b border-amber-glow/10">
        <nav class="max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
            <a href="#" class="flex items-center gap-3 group">
                <div
                    class="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-glow to-crimson-cta flex items-center justify-center shadow-glow-amber group-hover:scale-105 transition-transform">
            ...
            <ul class="hidden lg:flex items-center gap-10 text-sm font-medium text-white/70">
                ...
                <li><a href="#showcase" class="hover:text-amber-warm transition-colors" x-text="t('nav.specials')"></a>
                </li>
    ...
    <main>
        ...
        <section id="hero" class="relative min-h-screen flex items-center overflow-hidden">
            <div class="absolute inset-0 parallax-layer" data-parallax="0.3">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-charcoal-950 via-charcoal-950/70 to-charcoal-950/40">
                </div>
                <div class="absolute inset-0 bg-gradient-to-r from-charcoal-950/90 via-transparent to-charcoal-950/60">
                </div>
            </div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-32 pb-20 w-full">
                <div class="max-w-3xl">
                    <span
                        class="inline-block px-4 py-1.5 rounded-full bg-amber-glow/10 border border-amber-glow/30 text-amber-warm text-xs font-bold uppercase tracking-[0.2em] mb-6 hero-badge opacity-0">
                        <span x-text="t('hero.badge')"></span>
                    </span>

                    <h1
                        class="font-display text-5xl md:text-6xl xl:text-7xl font-black leading-[1.05] mb-4 hero-title opacity-0">
                        <span class="inline-flex items-center gap-3 text-white">
                            ...
                            <div class="fire-container relative inline-block align-middle w-12 h-12 md:w-16 md:h-16">
                                ...
                                <svg class="flame-core w-full h-full" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        <linearGradient id="flameGrad" x1="12" y1="22" x2="12"
                                    ...
                                    <path
                                        d="M12 23C16.1421 23 19.5 19.6421 19.5 15.5C19.5 11.5 16 8 13.5 3.5C13.2 8 10 9.5 8.5 12C7.5 10.5 7 9 7.5 7.5C5 10 4.5 13 4.5 15.5C4.5 19.6421 7.85786 23 12 23Z"
                                        fill="url(#flameGrad)" />
                                    <path
                                        d="M12 20.5C14.2091 20.5 16 18.7091 16 16.5C16 14.5 14 12.5 12.5 9.5C12.3 12.5 10.5 13.5 9.5 15C9 14 8.5 13 9 12C7.5 13.5 7 15 7 16.5C7 18.7091 8.79086 20.5 12 20.5Z"
                    ...
                    <div class="flex flex-wrap items-center gap-5 hero-cta opacity-0">
                        <button @click="scrollToMenu()"
                            ...
                            <span class="relative z-10 flex items-center gap-3">
                                ...
                                <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform flip-rtl"
                ...
                <div class="hidden xl:block absolute bottom-20 end-10 w-80 hero-float-card opacity-0">
                    <div class="relative rounded-3xl overflow-hidden shadow-food-depth border border-amber-glow/20 animate-float cursor-pointer"
                        ...
                        <img :src="featuredDish ? featuredDish.image :
                            'https://images.unsplash.com/photo-1568901346715-366b9e2d4f4d?w=600&q=90'"
                            alt="Signature Dish" class="w-full h-52 object-cover sizzle-effect">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-charcoal-950 via-transparent to-transparent">
                        </div>
                        <div class="absolute bottom-0 inset-x-0 p-5">
                            <span class="text-amber-warm text-xs font-bold uppercase tracking-wider"
                                x-text="t('hero.featured')"></span>
                            <h3 class="font-display text-xl font-bold mt-1"
                                x-text="featuredDish ? (featuredDish.name[locale] || featuredDish.name) : t('hero.featuredName')">
                            </h3>
                            <p class="text-amber-warm font-bold text-lg mt-1"
                                x-text="'$' + (featuredDish ? featuredDish.price.toFixed(2) : '18.99')"></p>
                        </div>
                        <div
                            class="cheese-layer absolute bottom-16 start-1/2 -translate-x-1/2 w-24 h-3 bg-amber-warm/60 rounded-full blur-sm">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="showcase" class="relative py-28 wood-section overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
                <div class="text-center mb-16 showcase-header">
                    <span class="text-amber-warm text-xs font-bold uppercase tracking-[0.25em]"
                        x-text="t('showcase.label')"></span>
                    <h2 class="font-display text-4xl md:text-5xl font-black mt-3 mb-4" x-text="t('showcase.title')">
                    </h2>
                ...
                <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12 menu-header">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 items-center w-full lg:w-auto">
                        <div class="relative w-full sm:w-64">
                            <input type="text" x-model="searchQuery" :placeholder="t('menu.search_placeholder')"
                            ...
                            <button x-show="searchQuery.length > 0" @click="searchQuery = ''"
                                ...
                                :class="locale === 'ar' ? 'left-10' : 'right-10'" type="button">
                                ✕
                            </button>

                            <span class="absolute top-1/2 -translate-y-1/2 text-white/30"
                ...
                <div x-show="filteredMenu.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <template x-for="item in filteredMenu" :key="item.id">
                        <article
                            ...
                            x-transition:enter-end="opacity-100 translate-y-0" @click="openCustomizer(item)">
                            <div class="relative aspect-square overflow-hidden">
                                ...
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-charcoal-900/80 via-transparent to-transparent">
                                </div>

                                <div class="absolute top-3 start-3 flex flex-wrap gap-1.5">
                                    <template x-for="badge in (item.badges || [])" :key="badge">
                                        <span
                                            class="px-2 py-0.5 rounded-md text-[9px] font-bold uppercase tracking-wide backdrop-blur-md"
                                ...
                                <div
                                    class="cheese-layer absolute bottom-0 inset-x-0 h-8 bg-gradient-to-t from-amber-warm/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                                </div>
                            </div>

                            <div class="p-5">
                                <h3 class="font-semibold text-lg mb-1 group-hover:text-amber-warm transition-colors"
                                    x-text="item.name[locale] || item.name"></h3>
                                <p class="text-white/40 text-sm line-clamp-2 mb-3"
                                    x-text="item.desc ? item.desc[locale] : item.description"></p>
                                <div class="flex items-center justify-between">
                                    <span class="text-amber-warm font-bold text-lg"
        ...
        ═══════════════════════════════════════════════════════════════ -->
        <section id="about"
            class="py-20 bg-gradient-to-r from-charcoal-950 via-charcoal-800 to-charcoal-950 border-y border-amber-glow/10">
            <div class="max-w-4xl mx-auto px-6 text-center">
                ...
                <button @click="cartOpen = true"
                    ...
                    @mousedown="createRipple($event)" x-text="t('about.cta')">
                </button>
            </div>
        </section>
    </main>
    ...
    <div x-show="modalOpen" x-cloak x-transition:enter="transition ease-out duration-300"
        ...
        <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300 delay-75"
                ...
                <div class="grid md:grid-cols-2">
                    ...
                    <div class="relative aspect-square md:aspect-auto md:min-h-[480px] overflow-hidden">
                        <img :src="selectedItem.image" :alt="selectedItem.name[locale] || selectedItem.name"
                            ...
                            :class="customizerZoom ? 'scale-125' : 'scale-100'" @mouseenter="customizerZoom = true"
                            @mouseleave="customizerZoom = false">
                        <div class="absolute inset-0 bg-gradient-to-t from-charcoal-800/60 to-transparent md:bg-none">
                        </div>
                    ...
                    <div class="p-6 lg:p-8 flex flex-col justify-between">
                        <div>
                            <span class="text-amber-warm text-xs font-bold uppercase tracking-wider"
                                x-text="t('modal.customize')"></span>
                            <h3 class="font-display text-3xl font-black mt-2 mb-2"
                                x-text="selectedItem.name[locale] || selectedItem.name"></h3>
                            <p class="text-white/50 text-sm mb-6"
                                x-text="selectedItem.desc ? selectedItem.desc[locale] : selectedItem.description"></p>
                        ...
                        <div class="border-t border-white/5 pt-6">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="text-end">
                                    ...
                                    <p class="text-amber-warm font-black text-2xl"
                                        x-text="'$' + modalTotal.toFixed(2)"></p>
                                </div>
                            </div>
    ...
    ═══════════════════════════════════════════════════════════════ -->
    <div x-show="cartOpen" x-cloak class="fixed inset-0 z-[110]" @keydown.escape.window="cartOpen = false">

        <div x-show="cartOpen" x-transition:enter="transition ease-out duration-300"
            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
            x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0" class="absolute inset-0 bg-charcoal-950/80 backdrop-blur-sm"
        ...
        <div x-show="cartOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="p-6 border-b border-white/5 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 rounded-xl bg-amber-glow/10 border border-amber-glow/30 flex items-center justify-center">
                        <svg class="w-5 h-5 text-amber-warm" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                ...
                <button @click="cartOpen = false"
                    class="w-9 h-9 rounded-xl bg-charcoal-800 flex items-center justify-center hover:bg-charcoal-700 transition-colors cursor-pointer">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12" />
                    </svg>
                ...
                <template x-for="item in cart" :key="item.cartId">
                    <div class="flex items-center gap-4 p-4 rounded-2xl bg-charcoal-800/60 border border-white/5">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-white/40 text-xs truncate" x-show="item.customizationsText"
                                x-text="item.customizationsText"></p>
                            <span class="text-amber-warm font-bold text-sm"
                                x-text="'$' + (item.price * item.quantity).toFixed(2)"></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <button @click="updateCartQty(item.cartId, -1)"
                                class="w-7 h-7 rounded-lg bg-charcoal-700 flex items-center justify-center hover:bg-charcoal-600 transition-colors cursor-pointer">−</button>
            ...
            <div class="p-6 border-t border-white/5 space-y-4 bg-charcoal-950/50" x-show="cart.length > 0">
                <div class="flex gap-2">
                    <input type="text" x-model="promoCode" :placeholder="t('cart.promoPlaceholder')"
                ...
                <div x-show="promoApplied" class="text-green-400 text-xs font-semibold"
                    x-text="t('cart.promoSuccess')"></div>
                ...
                <div class="space-y-2 text-sm text-white/60">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-white font-medium"
                            x-text="cartDelivery === 0 ? t('cart.free') : '$' + cartDelivery.toFixed(2)"></span>
                    </div>
                    <div class="flex justify-between text-base font-bold text-white pt-2 border-t border-white/5">
                        <span x-text="t('cart.total')"></span>
                        <span class="text-amber-warm font-black text-xl"
                            x-text="'$' + cartFinalTotal.toFixed(2)"></span>
                    </div>
                </div>

                <button @click="checkout()" :disabled="isSubmittingOrder"
                    ...
                    @mousedown="createRipple($event)">
                    <span x-show="!isSubmittingOrder"
                        x-text="t('cart.checkout') + ' — $' + cartFinalTotal.toFixed(2)"></span>
    ...
    ═══════════════════════════════════════════════════════════════ -->
    <div x-show="toast.visible" x-cloak x-transition:enter="transition ease-out duration-300"
    ...
    <!-- ═══════════════════════════════════════════════════════════════
         7. RECEIPT MODAL
    ═══════════════════════════════════════════════════════════════ -->
    <div x-show="receiptOpen" x-cloak class="fixed inset-0 z-[130] flex items-center justify-center p-4"
        ...
        <div
            class="relative w-full max-w-lg rounded-3xl bg-charcoal-900 border border-amber-glow/30 shadow-2xl p-8 overflow-hidden">
            <div class="text-center mb-6">
                <div
                    class="w-14 h-14 mx-auto rounded-2xl bg-gradient-to-br from-green-500 to-amber-warm flex items-center justify-center text-white text-2xl shadow-glow-amber mb-3">
                    ✓</div>
                <h3 class="font-display text-2xl font-black text-white"
                    x-text="locale === 'ar' ? 'تم تأكيد طلبك بنجاح!' : 'Order Confirmed!'"></h3>
                <p class="text-amber-warm font-mono text-sm mt-1"
                    x-text="lastOrder ? ('#' + lastOrder.order_number) : ''"></p>
            </div>
            <div class="bg-charcoal-800/70 rounded-2xl p-5 border border-white/5 space-y-3 mb-6">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="text-green-400 font-bold uppercase tracking-wider text-xs">Pending / قيد
                        التحضير</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-white/60" x-text="locale === 'ar' ? 'المجموع المدفوع' : 'Total Paid'"></span>
                    <span class="text-amber-warm font-bold text-base"
                        x-text="'$' + (lastOrder ? lastOrder.total_price.toFixed(2) : '0.00')"></span>
                </div>
            </div>
    ...
    <script>
        ...
        window.__INITIAL_SPICY_DISH = <?php echo json_encode($spicyDish ?? null, 15, 512) ?>;
        window.__INITIAL_SHOWCASE_DISHES = <?php echo json_encode($showcaseDishes ?? [], 15, 512) ?>;
        window.__INITIAL_MENU_ITEMS = <?php echo json_encode($menuItems ?? [], 15, 512) ?>;
        window.__INITIAL_CATEGORIES = <?php echo json_encode($categories ?? [], 15, 512) ?>;
        window.__INITIAL_ADDON_CATEGORIES = <?php echo json_encode($addonCategories ?? [], 15, 512) ?>;
            ...
            return {
                ...
                badgeStyles: {
                    'bestseller': {
                        ar: 'الأكثر مبيعاً',
                        en: 'Bestseller',
                        class: 'bg-green-500/30 text-green-200 backdrop-blur-md'
                    },
                    'chef-special': {
                        ar: 'طبق الشيف',
                        en: "Chef's Special",
                        class: 'bg-purple-500/30 text-purple-200 backdrop-blur-md'
                    },
                    'crispy-hot': {
                        ar: 'مقرمش وساخن',
                        en: 'Crispy & Hot',
                ...
                get filteredMenu() {
                    ...
                    if (this.activeCategory !== 'all') {
                        items = items.filter(i => i.category === this.activeCategory || i.category_id == this
                            .activeCategory);
                    }
                    if (this.searchQuery.trim() !== '') {
                        ...
                        items = items.filter(i => {
                            ...
                            return nameAr.includes(q) || nameEn.includes(q) || descAr.includes(q) || descEn
                                .includes(q);
                        });
                    }
                    return items;
